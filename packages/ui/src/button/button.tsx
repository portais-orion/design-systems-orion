...
/*
 * Portado de portal-supertrans (apps/web/src/components/ui/button.tsx).
 * Regras: apenas tokens semânticos (bg-primary, text-destructive, ...);
 * nenhuma cor de marca hardcoded — a marca é resolvida por CSS variables.
 */
