...
O `nucleo-portais` (**Design System Orion**) é a base oficial para criação, padronização e evolução dos portais das empresas do grupo. Não é uma biblioteca da Supertrans nem uma cópia do Aurora: é uma curadoria do melhor dos dois portais, mantida como plataforma.
