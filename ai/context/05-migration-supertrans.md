...
Plano (executado no repo DELE, não aqui): substituir `apps/web/src/components/ui/*` por re-exports de `@grupo/ui`; importar `@grupo/tokens` no globals.css mantendo aliases atuais; expectativa de zero mudança visual.
