...
Regra de ouro: APIs do Aurora são a inspiração; o CÓDIGO (Radix, TW3, `bg-white`/`text-gray-*`/`primary-500` hardcoded) nunca é copiado — sempre recriado sobre `@grupo/ui` + tokens.
